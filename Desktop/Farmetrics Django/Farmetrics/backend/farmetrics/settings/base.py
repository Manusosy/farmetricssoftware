"""
Django base settings for Farmetrics project.
...
WSGI_APPLICATION = 'farmetrics.wsgi.application'
ASGI_APPLICATION = 'farmetrics.asgi.application'
...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='noreply@farmetrics.com')
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Farmetrics API',
    'DESCRIPTION': 'Enterprise farm monitoring and field operations management platform',
    'VERSION': '1.0.0',
...
LOGGING = {
    ...
    'handlers': {
        ...
        'file': {
            ...
            'filename': BASE_DIR / 'logs' / 'farmetrics.log',
...
PHONENUMBER_DEFAULT_REGION = 'GH'  # Ghana as default (cocoa farming region)
PHONENUMBER_DEFAULT_FORMAT = 'INTERNATIONAL'

# Multi-tenancy Settings
ORGANIZATION_MODEL = 'organizations.Organization'
ORGANIZATION_SUBDOMAIN_ENABLED = config('ORGANIZATION_SUBDOMAIN_ENABLED', default=False, cast=bool)
